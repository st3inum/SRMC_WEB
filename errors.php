        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4	 is-offset-4">
                    <div class="box">
                    	<p style="font-family: cartoon; font-size: 100px; color: black;" >ERROR</p>
                        <form class="home" action="home.php" method="post">
    						<button type="submit" name="logout-btn" class="button is-success is-medium is-fullwidth is-outlined is-rounded">Logout</button>
                        </form> 
